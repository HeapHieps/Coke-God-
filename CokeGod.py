...
async def on_message(message):
    ...
    messages = message.content.lower() #Will check all messages in lowercase
...
client.run("MTA2NTE0ODY4ODgwNjE5MTI0NA.GvJQoE.KYUhyPEqM003LpVySHcaYdQITkIjDClWgZD9vs")
